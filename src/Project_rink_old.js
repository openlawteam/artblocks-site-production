                ...
                <Col xs={12} sm={6} md={9}>
                          ...
                          {this.props.nonInter.includes(
                            ...
                            <Image
                              ...
                              src={tokenImageHighlight(
                                (complete
                                  ? random
                                  : Number(this.state.projectTokenDetails[2]) -
                                    1) +
                                  this.props.project * 1000000
                              )}
                            />
                  ...
                  {this.state.artistInterface && (
                    <Col>
                      ...
                      <p>
                        Below you can control your project's representation on
                        the blockchain.{' '}
                        <b>
                          Only adjust settings that you are comfortable with.{' '}
                        </b>
                      </p>
                      <p>
                        Please be mindful of <i>which</i> fields that are
                        modifable after a project is locked. Some are and some
                        are not. Once a project is locked it is frozen
                        permanently/immutably so choose wisely.
                      </p>
                      ...
                      <Tabs
                        ...
                        <Tab eventKey="project" title="Project">
                          ...
                          <div>
                            <Form
                              onSubmit={(e) =>
                                this.handleChange(e, 'artistName')
                              }>
                              <Form.Group>
                                <Form.Label>
                          ...
                          <div>
                            <Form
                              onSubmit={(e) => this.handleChange(e, 'website')}>
                              <Form.Group>
                                <Form.Label>
                                ...
                                />
                                <Form.Text className="text-muted">
                                  This can be modified after a project is
                                  locked.
                                </Form.Text>
                              </Form.Group>
                              <Button variant="primary" type="submit">
                          ...
                          <div>
                            <Form
                              onSubmit={(e) => this.handleChange(e, 'license')}>
                              <Form.Group>
                                <Form.Label>
                                  <b>Update License</b>
                                </Form.Label>
                        ...
                        <Tab eventKey="token" title="Token">
                          <div>
                            <br />
                            <Form
                              onSubmit={(e) => this.handleChange(e, 'price')}>
                              <Form.Group>
                                <Form.Label>
                              ...
                              <Form
                                ...
                                <Form.Group>
                                  ...
                                  <Form.Text className="text-muted">
                                    ...
                                    updated in the same function call so make
                                    sure you fill both in (or just the currency
                                    field if you're setting the currency to
                                    ETH.)
                                  </Form.Text>
                                </Form.Group>
                          ...
                          <div>
                            <Form
                              onSubmit={(e) =>
                                this.handleChange(e, 'maxInvocations')
                              }>
                              <Form.Group>
                                <Form.Label>
                        ...
                        <Tab eventKey="scripts" title="Scripts">
                          <div>
                            ...
                            <Form
                              onSubmit={(e) =>
                                this.handleChange(e, 'scriptJSON')
                              }>
                              <Form.Group>
                                <Form.Label>
                                ...
                                <br />
                                <Form.Label>
                                  The Script JSON provides information for the
                                  server to parse the script correctly. It is
                                  stored in the contract as a single string.
                                  This means you cannot update items
                                  individaully. The boxes below are
                                  pre-populated with the values currently set
                                  for the JSON. If you want to make an update,
                                  only modify the boxes you want to change and
                                  click "sumbit". Anything left blank will stay
                                  blank, any data you don't modify will remain
                                ...
                                <Form.Control
                                  onChange={(e) =>
                                    this.handleJSON(e, 'aspectRatio')
                                  }
                                  type="text"
                                  value={
                                    this.state.scriptJSON.aspectRatio || ''
                                  }
                                  placeholder="Required. Specify aspect ratio (width divided by height)."></Form.Control>
                                <Form.Label>Instructions:</Form.Label>
                                <Form.Control
                                  onChange={(e) =>
                                    this.handleJSON(e, 'instructions')
                                  }
                                  value={
                                    this.state.scriptJSON.instructions || ''
                                  }
                                  as="textarea"
                                  rows={3}
                                  type="text"
                                ...
                                <Form.Control
                                  onChange={(e) =>
                                    this.handleJSON(e, 'interactive')
                                  }
                                  value={
                                    this.state.scriptJSON.interactive || ''
                                  }
                                  type="text"
                                ...
                                {this.props.isWhitelisted && (
                                  <div>
                                    ...
                                    <Form.Control
                                      onChange={(e) =>
                                        this.handleJSON(e, 'curated')
                                      }
                                      value={
                                        this.state.scriptJSON.curated || ''
                                      }
                                      type="text"
                                      placeholder="If a project is curated set to true."></Form.Control>
                                  </div>
                                )}
                                <Form.Text className="text-muted">
                          ...
                          <div>
                            <Form
                              onSubmit={(e) =>
                                this.handleChange(e, 'updateScript')
                              }>
                              <Form.Group>
                                <Form.Label>
                          ...
                          <div>
                            <Form
                              ...
                              <Form.Group>
                                ...
                                />
                                <Form.Text className="text-muted">
                                  This <b>cannot</b> be modified after a project
                                  is locked. Mostly used for static (non script
                                  based) projects with assets stored on IPFS.
                                </Form.Text>
                              </Form.Group>
                              <Button variant="primary" type="submit">
                                Submit
                              ...
                              <Form.Group>
                                ...
                                <Form.Text className="text-muted">
                                  <b>
                                    ...
                                    purchase based on the percentage specified
                                    below. Can be changed after project is
                                    locked.
                                  </b>
                                </Form.Text>
                                <Form.Label>
                                ...
                                />
                                <Form.Text className="text-muted">
                                  This represents the percentage of net funds
                                  after subtracting Art Blocks percentage.
                                </Form.Text>
                                <Form.Text className="text-muted">
                                  The above data are combined into a single
                                  function therefore both most be populated even
                                  if you're only modifying one of them. Make
                                  sure both fields are filled in before
                                  submitting.
                                </Form.Text>
                              </Form.Group>
                              <Button variant="primary" type="submit">
                          ...
                          <div>
                            <Form
                              ...
                              <Form.Group>
                                ...
                                />
                                <Form.Text className="text-muted">
                                  Note this is not guaranteed. A platform must
                                  be willing to implement this feature
                                  specifically. This can be modified after a
                                  project is locked.
                                </Form.Text>
                              </Form.Group>
                              <Button variant="primary" type="submit">
                          ...
                          <div>
                            ...
                            <Form
                              ...
                              <Form.Group>
                                ...
                                <Form.Text className="text-muted">
                                  This can be modified after a project is
                                  locked. Modifying this will change where the
                                  metadata for each project is retreived.
                                </Form.Text>
                              </Form.Group>
                              <Button variant="primary" type="submit">
                                Submit
                            ...
                            <Form
                              ...
                              <Form.Group>
                                ...
                                <Form.Text className="text-muted">
                                  This can be modified after a project is
                                  locked. Modifying this will change where the
                                  metadata for each project is retreived when
                                  stored on IPFS.
                                </Form.Text>
                              </Form.Group>
                              <Button variant="primary" type="submit">
                          ...
                          {this.props.isWhitelisted && (
                            <div>
                              <Button
                                variant="danger mx-1 btn-block"
                                onClick={(e) =>
                                  this.handleChange(e, 'toggleActive')
                                }>
                                {this.state.projectTokenDetails &&
                                this.state.projectTokenDetails[4]
                              ...
                              <Button
                                variant="danger mx-1 btn-block"
                                onClick={(e) =>
                                  this.handleChange(e, 'toggleLocked')
                                }>
                                {this.state.projectScriptDetails &&
