...
class Project extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loadQueue: this.props.project * 1000000,
      account: "",
      tokenURIInfo: "",
      purchase: false,
      ineraction: false,
    ...
    if (type === "price") {
      await this.state.artBlocks.methods
        .updateProjectPricePerTokenInWei(
          this.props.project,
          this.props.web3.utils.toWei(this.state.formValue, "ether")
        )
        .send({
      ...
      await this.state.artBlocks.methods
        .updateProjectName(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .updateProjectArtistName(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .updateProjectWebsite(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .updateProjectDescription(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .updateProjectLicense(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .updateProjectMaxInvocations(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .addProjectScript(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .removeProjectLastScript(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .updateProjectArtistAddress(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .toggleProjectUseHashString(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .updateProjectAdditionalPayee(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .updateProjectAdditionalPayeePercentage(
          this.props.project,
          this.state.formValue
        )
        .send({
      ...
      await this.state.artBlocks.methods
        .updateProjectScriptJSON(
          this.props.project,
          JSON.stringify(this.state.scriptJSON)
        )
        .send({
          from: this.props.account,
        })
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .updateProjectIpfsHash(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .updateProjectBaseURI(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .updateProjectBaseIpfsURI(this.props.project, this.state.formValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      //alert(this.props.project, this.state.idValue, this.state.formValue);
      await this.state.artBlocks.methods
        .clearTokenIpfsImageUri(this.state.idValue)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .toggleProjectUseIpfsForStatic(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .toggleProjectIsDynamic(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .toggleProjectIsActive(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .toggleProjectIsPaused(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
      ...
      await this.state.artBlocks.methods
        .toggleProjectIsLocked(this.props.project)
        .send({
          from: this.props.account,
        })
        .once("receipt", (receipt) => {
  ...
  render() {
    ...
    if (this.state.projectTokens) {
      ...
      for (
        let number = 1;
        number <= Math.ceil(projectTokens.length / 20);
        number++
      ) {
        items.push(
          <Pagination.Item
    ...
    let scriptCount =
      this.state.projectScriptDetails && this.state.projectScriptDetails[1];
        ...
        >
                  ...
                  <div>
                    {(this.props.isWhitelisted ||
                      this.state.projectTokenDetails[0] ===
                        this.props.account) && (
                      <Button
                        onClick={this.handleToggleArtistInterface}
                        className="btn-primary btn-block"
                      >
          ...
          <Col xs={12} sm={6} md={9}>
            ...
            {!this.state.artistInterface && !this.state.latest && (
              <div>
                <CardDeck>
                  {this.state.projectTokens &&
                    this.state.projectTokens.map((token, index) => {
                      if (
                        this.state.projectTokens
                          .slice(
                              ...
                              >
                                <Card.Body>
                                  {this.state.loadQueue < token ? (
                                    ...
                                    <Card.Img
                                      variant="top"
                                      src={tokenThumb(token)}
                                      onLoad={this.handleNextImage}
                                    />
                                  )}
                                  <div className="text-center">
                                    <ButtonGroup size="sm">
            ...
            {this.state.artistInterface && (
              <Col>
                ...
                <p>
                  Below you can control your project's representation on the
                  blockchain.{" "}
                  <b>Only adjust settings that you are comfortable with. </b>
                </p>
                <p>
                  Please be mindful of <i>which</i> fields that are modifable
                  after a project is locked. Some are and some are not. Once a
                  project is locked it is frozen permanently/immutably so choose
                  wisely.
                </p>
                ...
                <Tabs defaultActiveKey="project" id="uncontrolled-tab-example">
                  <Tab eventKey="project" title="Project">
                    <div>
                      <br />
                      <Form
                        onSubmit={(e) => this.handleChange(e, "projectName")}
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <Form.Text className="text-muted">
                            This <b>cannot</b> be changed once project is
                            locked.
                          </Form.Text>
                        </Form.Group>
                    ...
                    <div>
                      <Form
                        onSubmit={(e) => this.handleChange(e, "artistName")}
                      >
                        <Form.Group>
                          <Form.Label>
                    ...
                    <div>
                      <Form
                        onSubmit={(e) => this.handleChange(e, "description")}
                      >
                        <Form.Group>
                          <Form.Label>
                  ...
                  <Tab eventKey="token" title="Token">
                      ...
                      <Form onSubmit={(e) => this.handleChange(e, "price")}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            min="0"
                            step="any"
                            placeholder={`Price for each purchase in ${this.state.currency}.`}
                          />
                          <Form.Text className="text-muted">
                            This can be modified after a project is locked.
                          </Form.Text>
                    ...
                    <div>
                      {this.props.project >= 3 && (
                        <Form
                          onSubmit={(e) =>
                            this.handleChange(e, "updateProjectCurrencyInfo")
                          }
                        >
                          <Form.Group>
                            <Form.Label>
                            ...
                            <Form.Text className="text-muted">
                              The above values <b>can</b> be changed once
                              project is locked. Both of these fields are
                              updated in the same function call so make sure you
                              fill both in (or just the currency field if you're
                              setting the currency to ETH.)
                            </Form.Text>
                          </Form.Group>
                    ...
                    <div>
                      <Form
                        onSubmit={(e) => this.handleChange(e, "maxInvocations")}
                      >
                        <Form.Group>
                          <Form.Label>
                  ...
                  <Tab eventKey="scripts" title="Scripts">
                    <div>
                      <br />
                      <Form
                        onSubmit={(e) => this.handleChange(e, "scriptJSON")}
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <br />
                          <Form.Label>
                            The Script JSON provides information for the server
                            to parse the script correctly. It is stored in the
                            contract as a single string. This means you cannot
                            update items individaully. The boxes below are
                            pre-populated with the values currently set for the
                            JSON. If you want to make an update, only modify the
                            boxes you want to change and click "sumbit".
                            Anything left blank will stay blank, any data you
                            don't modify will remain "as is" in the updated
                            script.
                          </Form.Label>
                          <br />
                          <Form.Label>
                            Current JSON:{" "}
                            {this.state.projectScriptDetails &&
                              this.state.projectScriptDetails[0]}
                          </Form.Label>
                          <br />
                          <Form.Label>Script Type:</Form.Label>
                          <Form.Control
                            onChange={(e) => this.handleJSON(e, "type")}
                            value={
                          ...
                          <Form.Control
                            onChange={(e) => this.handleJSON(e, "version")}
                            value={this.state.scriptJSON.version || ""}
                            type="text"
                            placeholder="Specify version number of script, if applicable."
                          ></Form.Control>
                          <Form.Label>Aspect Ratio (width/height):</Form.Label>
                          <Form.Control
                            onChange={(e) => this.handleJSON(e, "aspectRatio")}
                            type="text"
                            value={this.state.scriptJSON.aspectRatio || ""}
                            placeholder="Required. Specify aspect ratio (width divided by height)."
                          ></Form.Control>
                          <Form.Label>Instructions:</Form.Label>
                          <Form.Control
                            onChange={(e) => this.handleJSON(e, "instructions")}
                            value={this.state.scriptJSON.instructions || ""}
                            as="textarea"
                            rows={3}
                            type="text"
                          ...
                          <Form.Control
                            onChange={(e) =>
                              this.handleJSON(e, "animationLengthInSeconds")
                            }
                            value={
                              this.state.scriptJSON.animationLengthInSeconds ||
                              ""
                            }
                            type="number"
                          ...
                          <Form.Control
                            onChange={(e) => this.handleJSON(e, "interactive")}
                            value={this.state.scriptJSON.interactive || ""}
                            type="text"
                    ...
                    <div>
                      <Form
                        onSubmit={(e) => this.handleChange(e, "updateScript")}
                      >
                        <Form.Group>
                          <Form.Label>
                        ...
                        <Button
                          ...
                          onClick={(e) =>
                            this.handleChange(e, "removeLastScript")
                          }
                        >
                          Remove Last Script
                        </Button>
          ...
          */}
                    ...
                    <div>
                      <Form
                        onSubmit={(e) =>
                          this.handleChange(e, "updateProjectIpfsHash")
                        }
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <Form.Label>
                            Currently:{" "}
                            {this.state.projectScriptDetails &&
                              this.state.projectScriptDetails[3]}
                          </Form.Label>
                          <Form.Control
                            onChange={this.handleValueChange}
                            type="text"
                          ...
                          />
                          <Form.Text className="text-muted">
                            This <b>cannot</b> be modified after a project is
                            locked. Mostly used for static (non script based)
                            projects with assets stored on IPFS.
                          </Form.Text>
                        </Form.Group>
                        <Button variant="primary" type="submit">
                          Submit
                        ...
                        <Button
                          variant="primary mx-1"
                          onClick={(e) =>
                            this.handleChange(e, "useIpfsForStatic")
                          }
                        >
                          {this.state.projectURIInfo &&
                          this.state.projectURIInfo[2]
                  ...
                  <Tab eventKey="royalties" title="Royalties/Payees">
                    <div>
                      ...
                      <Form
                        onSubmit={(e) =>
                          this.handleChange(e, "updatePayeeInfo")
                        }
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <Form.Label>
                            Current Payee:{" "}
                            {this.state.projectTokenDetails &&
                              this.state.projectTokenDetails[5]}
                          </Form.Label>
                          <br />
                          <Form.Label>
                            Current Percentage:{" "}
                            {this.state.projectTokenDetails &&
                              this.state.projectTokenDetails[6]}
                            %
                          </Form.Label>
                          <br />
                          <br />
                          ...
                          <Form.Text className="text-muted">
                            <b>
                              This address will receive proceeds of each
                              purchase based on the percentage specified below.
                              Can be changed after project is locked.
                            </b>
                          </Form.Text>
                          <Form.Label>
                          ...
                          />
                          <Form.Text className="text-muted">
                            This represents the percentage of net funds after
                            subtracting Art Blocks percentage.
                          </Form.Text>
                          <Form.Text className="text-muted">
                            The above data are combined into a single function
                            therefore both most be populated even if you're only
                            modifying one of them. Make sure both fields are
                    ...
                    <div>
                      <Form
                        onSubmit={(e) =>
                          this.handleChange(
                            e,
                            "updateSecondaryMarketRoyaltyPercentage"
                          )
                        }
                      >
                        <Form.Group>
                          ...
                          <Form.Label>
                            Currently:{" "}
                            {this.state.projectRoyaltyInfo &&
                              this.state.projectRoyaltyInfo[3]}
                            %
                          </Form.Label>
                          <Form.Control
                            onChange={this.handleValueChange}
                          ...
                          />
                          <Form.Text className="text-muted">
                            Note this is not guaranteed. A platform must be
                            willing to implement this feature specifically. This
                            can be modified after a project is locked.
                          </Form.Text>
                        </Form.Group>
                        <Button variant="primary" type="submit">
                          Submit
                  ...
                  <Tab eventKey="uri" title="URI">
                    <div>
                      ...
                      <Form
                        onSubmit={(e) =>
                          this.handleChange(e, "updateProjectBaseURI")
                        }
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <br />
                          <Form.Label>
                            Current setting: {this.state.projectURIInfo[0]}
                          </Form.Label>
                          <Form.Control
                            onChange={this.handleValueChange}
                            type="url"
                          ...
                          <Form.Text className="text-muted">
                            This can be modified after a project is locked.
                            Modifying this will change where the metadata for
                            each project is retreived.
                          </Form.Text>
                        </Form.Group>
                        <Button variant="primary" type="submit">
                          Submit
                    ...
                    <div>
                      <Form
                        onSubmit={(e) =>
                          this.handleChange(e, "updateProjectBaseIpfsURI")
                        }
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <br />
                          <Form.Label>
                            Current setting: {this.state.projectURIInfo[1]}
                          </Form.Label>
                          <Form.Control
                            onChange={this.handleValueChange}
                            type="url"
                          ...
                          <Form.Text className="text-muted">
                            This can be modified after a project is locked.
                            Modifying this will change where the metadata for
                            each project is retreived when stored on IPFS.
                          </Form.Text>
                        </Form.Group>
                        <Button variant="primary" type="submit">
                          Submit
                    ...
                    <div>
                      ...
                      >
                        ...
                        <Button
                          variant="primary mx-1"
                          onClick={(e) =>
                            this.handleChange(e, "clearTokenIpfsImageUri")
                          }
                        >
                  ...
                  <Tab eventKey="danger" title="Danger">
                    <div>
                      ...
                      <Form
                        onSubmit={(e) =>
                          this.handleChange(e, "updateArtistAddress")
                        }
                      >
                        <Form.Group>
                          <Form.Label>
                          ...
                          <Form.Text className="text-muted">
                            <b>
                              Caution! Once you change the artist address
                              control of the project will immediately be
                      ...
                      {this.state.projectTokenDetails &&
                        this.state.projectTokenDetails[0] ===
                          ...
                          <Button
                            ...
                            onClick={(e) =>
                              this.handleChange(e, "togglePaused")
                            }
                          >
                            {this.state.projectScriptDetails &&
                            this.state.projectScriptDetails[5]
                    ...
                    {this.props.isWhitelisted && (
                      <div>
                        <Button
                          variant="danger mx-1 btn-block"
                          onClick={(e) => this.handleChange(e, "toggleActive")}
                        >
                          {this.state.projectTokenDetails &&
                        ...
                        <Button
                          variant="danger mx-1 btn-block"
                          onClick={(e) => this.handleChange(e, "toggleLocked")}
                        >
                          {this.state.projectScriptDetails &&
