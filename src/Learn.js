...
class Learn extends Component {
  ...
  render(){
    ...
    return(
      ...
      <p>To mint, visit a project while connected to Metamask. If you do not already have Metamask installed you'll need to visit <a href="https://metamask.io/">https://metamask.io/</a> to install the extension in your browser.</p>
      ...
      <p>After the transaction is confirmed you will be presented with your generative content! This is a one of a kind iteration generated by the project's algorithm. The resulting work is represented on the Ethereum network by a token which is a standard ERC721 compatible NFT token. This means you
        will instantly be able to see it in your account on various marketplace platforms like <a href="https://www.opensea.io">OpenSea</a>. </p>
      ...
      <p>After a project is locked, an artist can still modify the description and price per iteration in case they want to adjust the price of a work to accommodate variance in the price of Ethereum.</p>
      <br />
      <h5>API</h5>
      ...
      <p>Project creators can optionally designate an additional payee for each project. The creator will indicate the receiving address and % of the purchase price that will be sent to this additional payee instantly at the time of purchase. This feature will
      ...
      <br />
      <h5>Curation</h5>
      <p>While the processes for generating and viewing unique generative content on the Art Blocks platform are decentralized, the organization and operation of the Art Blocks platform itself is not decentralized. Artists/creators are selected to deploy projects at the sole discretion of the Art Blocks
