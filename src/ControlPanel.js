...
class ControlPanel extends Component {
  ...
  async handleChange(e,type){
    ...
    if (type === "newProject"){
    await this.state.artBlocks.methods.addProject(this.state.newProject.name, this.state.newProject.artistAddress, this.state.newProject.price, this.state.newProject.dynamic).send({
            ...
            <br/>
              <Form onSubmit={e => this.handleChange(e, "newProject")}>
                <Form.Group>
                  ...
                  <Form.Control onChange={e=>this.handleNewProjectValueChange(e,"projectName")} type="text" step="any" placeholder="Enter Project Name" />
                  <Form.Label><b>Artist Address</b></Form.Label>
                  <Form.Control onChange={e=>this.handleNewProjectValueChange(e,"artistAddress")} type="text" step="any" placeholder="Enter Artist Ethereum Address" />
